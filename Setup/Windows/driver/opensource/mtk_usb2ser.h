...
#define DEFAULT_READ_BUFFER_SIZE    (128 * 1024)    /* 128 KB ring buffer — mtkclient uses
                                                       fast mode with 1 MB host buffer and
                                                       rapid small reads during handshake;
                                                       128 KB prevents overflow at 921600 baud */
#define DEFAULT_WRITE_BUFFER_SIZE   (128 * 1024)
...
#define DEFAULT_IN_QUEUE_SIZE       8192            /* mtkclient reads in 512-byte chunks */
#define DEFAULT_OUT_QUEUE_SIZE      8192

/* Max baud rate supported — mtkclient uses 115200 initially, then
   switches to 460800 or 921600 for DA transfer performance */
