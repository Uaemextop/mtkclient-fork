...
/* MSR bit definitions - fallbacks for WDK 10.0.26100+ */
...
/* CDC ACM control line state bits */
#define CDC_CTL_DTR                 0x01
#define CDC_CTL_RTS                 0x02

/* CDC serial state notification bits */
...
#define DEFAULT_READ_BUFFER_SIZE    (64 * 1024)
#define DEFAULT_WRITE_BUFFER_SIZE   (64 * 1024)
#define MAX_TRANSFER_SIZE           4096
#define NUM_CONTINUOUS_READERS      8
